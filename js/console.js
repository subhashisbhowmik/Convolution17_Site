...
function con_clear() {
    setTimeout(function () {
        $console.html("");
        if ($('#tab-algomaniac').hasClass('active'))
            loop(0);
        else {
            loop(-2);
        }
